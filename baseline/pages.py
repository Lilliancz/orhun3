...
class Comprehension(Page):
    ...
    def vars_for_template(self):
        ...
        if self.player.firm == "A":
            self.player.q3question = "True or False: I will be shown the scores of my opponents from part 1 before " \
                                     "entering the competition."
            self.player.q3explanation = "Each participant will be shown the scores of his/her opponents from part 1 " \
                            "before entering the competition."
        if self.player.firm == "B":
            self.player.q3question = "True or False: I will not know the scores of my opponents before " \
                                     "entering the competition."
            self.player.q3explanation = "Each participant knows their own score from part 1, but does not know " \
                            "the scores of his/her opponents before entering the competition."
        return {
